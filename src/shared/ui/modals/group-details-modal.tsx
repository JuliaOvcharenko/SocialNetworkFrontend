...
const UserRow = React.memo(({ item, onRemove }: { item: IUser, onRemove: (id: number) => void }) => {
    const activeAvatar = item.avatars?.find(a => a.isActive)?.image?.normalImageURL;
    const avatarUri = activeAvatar ? `${BASE_URL}${activeAvatar}` : null;
                ...
                <Pressable style={styles.modalContent} onPress={() => { }}>
                    ...
                    <View style={styles.membersSection}>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => <UserRow item={item} onRemove={onRemoveUser} />}
                        />
                    </View>
