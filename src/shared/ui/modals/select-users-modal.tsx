...
const UserItem = React.memo(({ item, isSelected, onToggle }: {
    item: IUser,
    isSelected: boolean,
    ...
    return (
        ...
        >
            <View style={styles.avatarContainer}>
                ...
                <View style={[styles.statusIndicator, { backgroundColor: item.isOnline ? COLOURS.Green100 : COLOURS.Gray }]} />
            </View>
...
export function SelectUsersModal({
    visible, onClose, users, onSave, title, buttonText
    ...
    const groupedUsers = useMemo(() => groupUsersByAlphabet(users, search), [users, search]);
    ...
    let indicatorHeight = Math.max((safeContainerHeight / safeContentHeight) * safeContainerHeight, 30);
        ...
        <Modal visible={visible} animationType="fade" transparent={true} onRequestClose={onClose}>
            <Pressable style={styles.overlay} onPress={onClose}>
                <Pressable style={styles.modalContent} onPress={() => { }}>
                    ...
                    <SearchInput value={search} onChangeText={setSearch} placeholder="Пошук" />

                    <Text style={styles.selectedCount}>Вибрано: {selectedIds.length}</Text>
